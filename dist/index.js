      ...
      var paper = function(self2, undefined2) {
        ...
        var Curve = Base.extend(
          ...
          },
          {
            ...
            divideAt: function(location2) {
              return this.divideAtTime(location2 && location2.curve === this ? location2.time : this.getTimeAt(location2));
            },
            ...
            splitAt: function(location2) {
              var path = this._path;
              return path ? path.splitAt(location2) : null;
            },
          ...
          new function() {
            ...
            return Base.each(
              methods,
              function(name) {
                this[name + "At"] = function(location2, _isTime) {
                  var values = this.getValues();
                  return Curve[name](values, _isTime ? location2 : Curve.getTimeAt(values, location2));
                };
        ...
        var Path = PathItem.extend(
          ...
          },
          {
            ...
            divideAt: function(location2) {
              var loc = this.getLocationAt(location2), curve;
              return loc && (curve = loc.getCurve().divideAt(loc.getCurveOffset())) ? curve._segment1 : null;
            },
            splitAt: function(location2) {
              var loc = this.getLocationAt(location2), index = loc && loc.index, time = loc && loc.time, tMin = 1e-8, tMax = 1 - tMin;
              if (time > tMax) {
                index++;
                time = 0;
              }
            ...
            split: function(index, time) {
              var curve, location2 = time === undefined2 ? index : (curve = this.getCurves()[index]) && curve.getLocationAtTime(time);
              return location2 != null ? this.splitAt(location2) : null;
            },
          ...
          if (!acorn) {
            ...
            (function(root, mod) {
              ...
              function makePredicate(words) {
                words = words.split(" ");
                var f = "", cats = [];
                out: for (var i2 = 0; i2 < words.length; ++i2) {
                ...
                function compareTo(arr) {
                  ...
                  f += "switch(str){";
                  for (var i3 = 0; i3 < arr.length; ++i3) f += "case " + JSON.stringify(arr[i3]) + ":";
              ...
              function readToken_lt_gt(code) {
                ...
                if (next2 === code) {
                  ...
                  if (input2.charCodeAt(tokPos + size) === 61) return finishOp(_assign, size + 1);
              ...
              function readToken_eq_excl(code) {
                var next2 = input2.charCodeAt(tokPos + 1);
                if (next2 === 61) return finishOp(_equality, input2.charCodeAt(tokPos + 2) === 61 ? 3 : 2);
              ...
              function readHexNumber() {
                ...
                if (isIdentifierStart(input2.charCodeAt(tokPos))) raise(tokPos, "Identifier directly after number");
                    ...
                    if (octal) {
                      ...
                      switch (ch) {
                        ...
                        case 48:
                          ...
                          break;
                        case 13:
                          if (input2.charCodeAt(tokPos) === 10) ++tokPos;
                        case 10:
                          if (options.locations) {
                            tokLineStart = tokPos;
                            ++tokCurLine;
              ...
              function readWord1() {
                ...
                for (; ; ) {
                  ...
                  if (isIdentifierChar(ch)) {
                    if (containsEsc) word += input2.charAt(tokPos);
                    ++tokPos;
                  } else if (ch === 92) {
                    if (!containsEsc) word = input2.slice(start, tokPos);
                    containsEsc = true;
              ...
              function parseStatement() {
                ...
                switch (starttype) {
                  ...
                  case _continue:
                    ...
                    if (i2 === labels.length) raise(node.start, "Unsyntactic " + starttype.keyword);
                  ...
                  default:
                    ...
                    if (starttype === _name && expr.type === "Identifier" && eat(_colon)) {
                      for (var i2 = 0; i2 < labels.length; ++i2)
                        if (labels[i2].name === maybeName) raise(expr.start, "Label '" + maybeName + "' is already declared");
              ...
              function parseFunction(node, isStatement) {
                ...
                if (strict || node.body.body.length && isUseStrict(node.body.body[0])) {
                  for (var i2 = node.id ? -1 : 0; i2 < node.params.length; ++i2) {
                    ...
                    if (i2 >= 0) {
                      for (var j = 0; j < i2; ++j) if (id.name === node.params[j].name)
